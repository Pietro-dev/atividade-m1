...
public class ProductController {
    ...
    @Autowired
    public ProductController(ProductRepository repository, AddressSearch addressSearch, ProductService productService) {
    ...
    @GetMapping("/check-distribution-center")
    public ResponseEntity<Boolean> checkDelivery(@RequestParam String cep, @RequestParam String productId) {
        boolean resultado = productService.checkProductCenter(cep, productId);
